...
describe('class tests', () => {
    let notas = new Note()
    notas.addNote("adios", "Nota para decir adios", "orange", "Carlos")
    ...
    it('ModifyNote is used', () => {
        expect(notas.modifyNote("esta nota es para decir adios","orange", "adios", "Carlos")).to.be.equal(undefined);
    });
